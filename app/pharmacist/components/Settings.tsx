...
export function PharmacistSettings({ initialTab }: { initialTab?: Tab }) {
  ...
  const inputStyle: CSSProperties = {
    width: "100%", padding: "11px 14px", border: `1.5px solid ${t.cardBorder}`,
    borderRadius: 8, fontSize: 14, fontFamily: "inherit", background: t.cardBg, color: t.text,
    outline: "none", boxSizing: "border-box", transition: "border-color 0.2s",
  };
  const labelStyle: CSSProperties = {
    fontSize: 11, fontWeight: 700, letterSpacing: "0.07em", color: t.text3, marginBottom: 6,
  ...
  if (isLoading) return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", color: t.text3, fontFamily: "inherit" }}>Loading…</div>
  );
            ...
            {tab === "profile" && (
              <>
                ...
                <button type="button" onClick={handleSaveProfile} disabled={saving} style={{
                  ...
                  {saving ? <><SpinnerIcon size={13} color="#fff" /> Saving…</> : <><CheckIcon size={13} color="#fff" /> Save Changes</>}
                </button>
              </>
            )}
              ...
              <>
                ...
                <button type="button" onClick={handleChangePassword}
                  ...
                  style={{
                    ...
                    borderRadius: 22, padding: "11px 30px", fontSize: 13, fontWeight: 700,
                  ...
                  {pwSaving ? <><SpinnerIcon size={13} color="#fff" /> Changing…</> : <><LockIcon size={13} color="#fff" /> Change Password</>}
                </button>
              </>
            )}
              ...
              {([
                ...
                <div key={label} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 14 }}>
                  <div style={{
                    ...
                    border: `2px solid ${met ? t.green : t.border2}`, background: met ? t.green : "transparent",
          ...
          <div style={{ background: t.cardBg, borderRadius: 18, width: "100%", maxWidth: 480, overflow: "hidden", boxShadow: "0 24px 64px rgba(0,0,0,.28)" }}>
            ...
            <div style={{ padding: "12px 22px", display: "flex", justifyContent: "flex-end", gap: 10, borderTop: `1px solid ${t.cardBorder}` }}>
              ...
              <button type="button" onClick={capturePhoto} disabled={uploading} style={{
                background: t.green, color: "#fff", border: "none", borderRadius: 20, padding: "8px 22px", fontSize: 13, fontWeight: 600,
                cursor: uploading ? "not-allowed" : "pointer", fontFamily: "inherit", opacity: uploading ? 0.7 : 1, display: "flex", alignItems: "center", gap: 6,
              }}>
                {uploading ? <><SpinnerIcon size={13} color="#fff" /> Saving…</> : <><CameraIcon size={13} color="#fff" /> Capture</>}
              </button>
            </div>
          </div>
        </div>
